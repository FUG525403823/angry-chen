...
describe('对局状态编解码', () => {
  const state: MatchState = {
    ...
    intermissionMs: 5000,
    players: [
      { pid: 1, name: '陈sir', ready: true, weapon: 1, hpRatio: 0.5, kills: 12 },
      { pid: 2, name: 'player2', ready: false, weapon: 0, hpRatio: 1, kills: 0 },
      { pid: 3, name: '羊群克星', ready: true, weapon: 2, hpRatio: 0.25, kills: 99 },
      { pid: 4, name: 'p4', ready: true, weapon: 0, hpRatio: 0, kills: 1 },
    ],
  };
